...
For $P$ the app uses the year's average market price — how his May 2026 formula table defines
it, and his choice for companies with no buyback; in the NASDAQ-100 study he used the buyback
program's own average price where one existed. On Salesforce the difference is worth about
four points of ΔE. The floor of $V$ at zero is his rule (10-K extraction protocol, step 9).
