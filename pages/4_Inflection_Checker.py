...
def self_test() -> list[tuple[str, bool, str]]:
    ...
    _n = ["Revenue is growing faster than it was — x", "Latest revenue growth is 56%, which is a launch rate",
          "FY2022 excluded — no share price, per Gate 2."]
...
if years and ticker and st.session_state.get("inf_tk") == ticker:
    ...
    # rendered with the live gates because that is where this page decides.
    # Verified consolidated income → the basis banner and the IV15 below it
    # on one basis; unverified → the surviving stop, "Refused." prefix as
    # before.
